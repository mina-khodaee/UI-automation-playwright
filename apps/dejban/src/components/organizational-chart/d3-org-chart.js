...
export class OrgChart {
    ...
    render() {
        ...
        if (attrs.firstDraw) {
            attrs.centerG.attr("transform", () => attrs.layoutBindings[attrs.layout].centerTransform({
    ...
    update({ x0, y0, x = 0, y = 0, width, height }) {
        ...
        nodeUpdate
            ...
            .attr("opacity", 0)
            .duration(attrs.duration)
            .attr("transform", ({ x, y, width, height }) => attrs.layoutBindings[attrs.layout].nodeUpdateTransform({ x, y, width, height }))
            .attr("opacity", 1);
        ...
        nodeUpdate.select(".node-button-g").attr("transform", ({ data, width, height }) => {
            ...
            .attr("display", ({ data }) => data._directSubordinates > 0 ? null : 'none')
        ...
        nodeUpdate
            ...
            .html((node) => attrs.buttonContent({ node, state: attrs }))
