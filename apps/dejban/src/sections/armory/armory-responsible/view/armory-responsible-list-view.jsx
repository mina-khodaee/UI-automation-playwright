...
import { ArmoryResponsibleNewEditForm } from '../armory-responsible-new-edit-form';

export function ArmoryResponsibleListView() {
  ...
  const allArmoryResponsible = data?.items || [];
