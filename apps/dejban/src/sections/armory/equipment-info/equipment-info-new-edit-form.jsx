...
export function EquipmentInfoNewEditForm({ currentEquipment, open, onClose, onRefetch }) {
    ...
    const onSubmit = handleSubmit(async (data) => {
        try {
            if (currentEquipment) {
                await updateMajors.mutateAsync({ id: currentEquipment.id, ...data });
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
            <DialogTitle textAlign="center">
                {currentEquipment ? 'ویرایش تجهیزات' : 'ایجاد تجهیزات'}
            </DialogTitle>
