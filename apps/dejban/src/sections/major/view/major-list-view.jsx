...
import { MajorNewEditForm } from '../major-new-edit-form';
...
export function MajorListView() {
  ...
  const columns = useMemo(() => [
    {
      accessorKey: 'name',
      header: t_majors('columns.majorsName'),
      size: 150,
    },
    {
      accessorKey: 'code',
      header: t_majors('columns.code'),
      size: 150,
    },
    {
      accessorKey: 'description',
      header: t_majors('columns.description'),
      size: 180,
    },
  ], [currentLang]);
  ...
  return (
    <>
      <DashboardContent maxWidth="xxl">
        <CustomBreadcrumbs
          heading={t_majors('breadcrumb.majors')}
          action={
            <Button
              color="inherit"
