            ...
            <Table sx={{ width: '100%', borderCollapse: 'collapse' }}>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ px: 1, py: 0.5 }}>گروه</TableCell>
                  <TableCell sx={{ px: 1, py: 0.5 }}>آیتم‌ها</TableCell>
              ...
              <TableBody>
                {fields.map((row) => (
                  <TableRow key={row.id} sx={{ '& > *': { borderBottom: 'none' }, height: 36 }}>
                    <TableCell sx={{ px: 1, py: 0.5 }} />
                    <TableCell sx={{ px: 1, py: 0.5 }}>{row.groupName}</TableCell>
                    <TableCell sx={{ px: 1, py: 0.5 }}>{row.itemNames?.join(' - ')}</TableCell>
                    <TableCell sx={{ px: 1, py: 0.5 }} align="right">
                      <IconButton
                        color="error"
