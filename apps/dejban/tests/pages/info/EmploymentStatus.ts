...
export class EmploymentStatus {
  ...
  constructor(page: Page) {
    ...
    this.employmentTypesMenu = page.getByText('انواع اشتغال');

    this.addEmploymentButton = page.getByRole('button', {
      name: 'افزودن نوع اشتغال جدید',
    });
    ...
    this.createEmployment = page.getByText('ایجاد نوع اشتغال');
    ...
    this.editEploymentDialog = page.getByText('ویرایش نوع اشتغال');
  ...
  async verifyDuplicateEmploymentError() {
    await expect(this.page.getByText('این نوع اشتغال قبلا ثبت شده است')).toBeVisible();
  }
  ...
  async deletEmployment(name: string) {
    ...
    await expect(this.page.getByText('حذف نوع اشتغال با موفقیت انجام شد')).toBeVisible();
  ...
  async editEmployment(
    ...
    await expect(this.page.getByText('به‌روزرسانی نوع اشتغال با موفقیت انجام شد')).toBeVisible();
