...
import { navItemStyles, navSectionClasses } from '../styles/index';
// ----------------------------------------------------------------------
 ...
 * @slot caption icon
 */
const ItemCaptionIcon = styled(IconifyLocal, { shouldForwardProp })(({ theme }) => ({
 ...
 * @slot arrow
 */
const ItemArrow = styled(IconifyLocal, { shouldForwardProp })(({ theme }) => ({
