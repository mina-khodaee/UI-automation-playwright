...
export function RegionDoorStatus({ open, onClose, regionId }) {
    const setDoorStatus = useRegionActions((state) => state.setDoorStatus);
    ...
    const onSubmit = handleSubmit(async (data) => {
        try {
            await setDoorStatus({ id: regionId, ...data });
            // await deviceMutate();
            // await devicesMutate();
