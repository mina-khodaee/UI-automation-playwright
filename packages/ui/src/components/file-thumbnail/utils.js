...
// Store assetsDir for file icon URLs
let _assetsDir = '';

/**
 * Initialize file thumbnail utilities with app assets directory.
 * Call this once during app initialization.
 * @param {string} assetsDir - Base path for assets directory
 * @example
 ...
 */
export function initFileThumbnail(assetsDir = '') {
  _assetsDir = assetsDir;
}

const iconUrl = (icon) => `${_assetsDir}/assets/icons/files/${icon}.svg`;
