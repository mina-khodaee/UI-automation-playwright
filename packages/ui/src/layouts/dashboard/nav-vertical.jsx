...
export function NavVertical({ sx, data, slots, isNavMini, layoutQuery, onToggleNav, checkPermissions, loading, ...other }) {
  ...
  const renderNavVertical = (
    <>
      ...
      <Scrollbar fillContent>
        {loading ? (
          <Skeleton variant="rectangular" sx={{ px: 2, flex: '1 1 auto' }} />
        ) : (
          <NavSectionVertical
            data={data}
