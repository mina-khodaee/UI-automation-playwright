...
const getItems = (assetsDir) => [
  ...
  },
  {
    ...
    imgUrl: [
      `${assetsDir}/assets/images/home/highlight-presets-1.webp`,
      `${assetsDir}/assets/images/home/highlight-presets-2.webp`,
      `${assetsDir}/assets/images/home/highlight-presets-3.webp`,
      `${assetsDir}/assets/images/home/highlight-presets-4.webp`,
      `${assetsDir}/assets/images/home/highlight-presets-5.webp`,
    ],
  },
  {
    title: 'Right-to-left',
    ...
    imgUrl: [`${assetsDir}/assets/images/home/highlight-rtl.webp`],
  },
];
...
function ScrollableContent({ containerRoot }) {
  ...
  const { assetsDir } = useConfig();
  const ITEMS = getItems(assetsDir);
